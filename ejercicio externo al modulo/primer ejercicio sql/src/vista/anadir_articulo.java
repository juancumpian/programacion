...
public class anadir_articulo extends JDialog {
		...
		textid.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					if(ID.next()){
							esta=true;
							JOptionPane.showMessageDialog(null, "ya existe un usuario con esa ID");
					}
					if(!esta){
					...
					public void actionPerformed(ActionEvent e) {
						...
						if(textid.getText().isEmpty()|| textnom.getText().isEmpty() || texttipo.getText().isEmpty() || textprecio.getText().isEmpty() || textempresa.getText().isEmpty()){
							...
							if(!pepe){
								...
								operaciones.anadir(Integer.parseInt(textid.getText().toString()), textnom.getText().toString(),texttipo.getText().toString() , Float.parseFloat(textprecio.getText().toString()),textempresa.getText().toString());
								dispose();
							}
